...
assert(canCache(make()));assert(canCache(make('/he')));assert(canCache(make('/',{cookie:'__cf_bm=public-bot-check'})));assert.equal(canCache(make('/',{cookie:'__cf_bm=public; session=private'})),false);assert(canCache(make('/ja/robin')));
